...
**Live Demo**: [https://carbon-footprint-123.web.app](https://carbon-footprint-123.web.app) *(Placeholder)*
...
2. **Configure Environment Variables:**
   ...
   cp .env.example .env
   ```
   *Fill in your Firebase, Google Maps, and Gemini AI keys inside `.env`.*
