...
describe('InsightCard', (): void => {
  it('renders transport insight', (): void => {
  ...
  it('renders home energy insight', (): void => {
  ...
  it('renders shopping insight', (): void => {
  ...
  it('renders general insight', (): void => {
